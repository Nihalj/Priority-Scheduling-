...
int main() 
{ 
      int i, limit, total = 0, x, counter = 0, time_quantum,j,k; 
	...
	for(b=0;b<limit;b++)
		{
          ...
          average_wait_time=wait_time/(float)k;
          average_turnaround_time=turnaround_time/(float)k;
          printf("\n\nAverage Turnaround Time is = %3.2f ",average_turnaround_time);
          printf("\n\nAverage Waiting Time is = %3.2f",average_wait_time);
      return 0; 
